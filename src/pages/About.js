    ...
    return (
      <div className="about__container">
        ...
        <div className="about__content">
          ...
          <p>
            I am currently working as a Mobile Web Developer.  We are using Xamarin
            C# to maintain, develop and customize a family of iOS applications used
            for field research. Previously, I worked on an agile team to develop digital applications to replace
