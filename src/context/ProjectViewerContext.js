...
const ProjectViewerProvider = ({ children }) => {
  const [projects] = useState([
    {
      ...
      reports: [
        ...
        },
        {
          id: 109,
          name: 'Appendix',
          desc: 'Personas, Scenarios, Pretest/Post Test Docs, Interview Scripting ',
          artifactIcon: require('../images/efu.png'),
      ...
      artifacts: [
        ...
        },
        {
          ...
          desc: 'Once the initial data-gathering was complete, new wireframes were built.',
          artifactIcon: require('../images/efu.png'),
          altIcon: 'EFU Mockups',
      ...
      artifacts: [
        {
          id: 124,
          name: 'Mockups Final',
          desc: 'After several iterations of full color mockups, we agreed on this design.',
          artifactIcon: require('../images/do.png'),
  ...
  return (
    <ProjectViewerContext.Provider value={{ projects }}>
      {children}
